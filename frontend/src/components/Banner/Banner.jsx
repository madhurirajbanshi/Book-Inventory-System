    ...
    <div className="w-full order-2 md:order-1 md:w-1/2 mt-8 md:mt-28">
      <div className="space-y-6">
        ...
        <p className="text-sm md:text-xl">
          ...
          imagination. Whether you're exploring classics, mysteries, or gaining
          new insights, we bring the joy of books to you.
        </p>
      ...
      <button className="bg-pink-500 hover:bg-pink-600 text-white font-semibold py-3 px-6 rounded-lg shadow-md transition duration-300 mt-6">
        Get Started
      </button>
    </div>
